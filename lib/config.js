...
export const config = {
  searchProductsUrl: `${process.env.NEXT_PUBLIC_API_URL || 'http://localhost:8042'}/api/admin/get_all_product/search`,
  addToCartUrl: `${process.env.NEXT_PUBLIC_API_URL || 'http://localhost:8042'}/api/user/add_to_cart`,
      ...
      },
      {
        ...
        parameters: {
          ...
          properties: {
            ...
            productName: {
              type: Type.STRING,
              description: "The name of the product to add (for display purposes)."
            },
            quantity: {
              type: Type.NUMBER,
